...
int CTreeCtrlPfw::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	***/
	...
	pbasic.AddTail(_T("ALK"));
	pbasic.AddTail(_T("CALC_VALUE(\"..\")"));
	pbasic.AddTail(_T("CELL_NO"));
	pbasic.AddTail(_T("CHANGE_POR(.., ..)"));
	pbasic.AddTail(_T("CHANGE_SURF(\"..\", .., \"..\", .., ..)"));
	pbasic.AddTail(_T("CHARGE_BALANCE"));
	pbasic.AddTail(_T("DESCRIPTION"));
	pbasic.AddTail(_T("DIST"));
	pbasic.AddTail(_T("EDL(\"..\", \"..\")"));
	pbasic.AddTail(_T("EQUI(\"..\")"));
	pbasic.AddTail(_T("EXISTS(..[, .., ..])"));
	pbasic.AddTail(_T("GAS(\"..\")"));
	pbasic.AddTail(_T("GAMMA(\"..\")"));
	pbasic.AddTail(_T("GET(..[, .., ..])"));
	pbasic.AddTail(_T("GET_POR(..)"));
	pbasic.AddTail(_T("GRAPH_X"));
	pbasic.AddTail(_T("GRAPH_Y"));
	pbasic.AddTail(_T("GRAPH_SY"));
	pbasic.AddTail(_T("ISO(\"..\")"));
	pbasic.AddTail(_T("ISO_UNITS(\"..\")"));
	pbasic.AddTail(_T("KIN(\"..\")"));
	pbasic.AddTail(_T("LA(\"..\")"));
	pbasic.AddTail(_T("LG(\"..\")"));
	pbasic.AddTail(_T("LK_NAMED(\"..\")"));
	pbasic.AddTail(_T("LK_PHASE(\"..\")"));
	pbasic.AddTail(_T("LK_SPECIES(\"..\")"));
	pbasic.AddTail(_T("LM(\"..\")"));
	pbasic.AddTail(_T("M"));
	pbasic.AddTail(_T("M0"));
	pbasic.AddTail(_T("MISC1(\"..\")"));
	pbasic.AddTail(_T("MISC2(\"..\")"));
	pbasic.AddTail(_T("MOL(\"..\")"));
	pbasic.AddTail(_T("MU"));
	pbasic.AddTail(_T("OSMOTIC"));
	pbasic.AddTail(_T("PARM(..)"));
	pbasic.AddTail(_T("PERCENT_ERROR"));
	pbasic.AddTail(_T("PRINT"));
	pbasic.AddTail(_T("PUNCH"));
	pbasic.AddTail(_T("PUT(x, ..[, .., ..])"));
	pbasic.AddTail(_T("RHO_m"));
	pbasic.AddTail(_T("RHO_v"));
	pbasic.AddTail(_T("RXN"));
	pbasic.AddTail(_T("SAVE .."));
	pbasic.AddTail(_T("SC"));
	pbasic.AddTail(_T("SI(\"..\")"));
	pbasic.AddTail(_T("SIM_NO"));
	pbasic.AddTail(_T("SIM_TIME"));
	pbasic.AddTail(_T("SR(\"..\")"));
	pbasic.AddTail(_T("STEP_NO"));
	pbasic.AddTail(_T("SUM_GAS(\"{..}\",\"..\")"));
	pbasic.AddTail(_T("SUM_SPECIES(\"{..}\",\"..\")"));
	pbasic.AddTail(_T("SUM_S_S(\"..\",\"..\")"));
	pbasic.AddTail(_T("SURF(\"..\", \"..\") "));
	pbasic.AddTail(_T("SYS(\"..\")"));
	pbasic.AddTail(_T("S_S(\"..\")"));
	pbasic.AddTail(_T("TC"));
	pbasic.AddTail(_T("TK"));
	pbasic.AddTail(_T("TIME"));
	pbasic.AddTail(_T("TOT(\"..\")"));
	pbasic.AddTail(_T("TOTMOLE(\"..\")"));
	pbasic.AddTail(_T("TOTAL_TIME"));

	CTreeCtrlNode basic = this->InsertItem(_T("GENERAL BASIC statements"));
	basic.AddTail(_T("AND"));
	basic.AddTail(_T("OR"));
	basic.AddTail(_T("NOT"));
	basic.AddTail(_T("ABS(..)"));
	basic.AddTail(_T("ARCTAN(..)"));
	basic.AddTail(_T("ASC(\"..\")"));
	basic.AddTail(_T("CEIL(..)"));
	basic.AddTail(_T("CHR$(..)"));
	basic.AddTail(_T("COS(..)"));
	basic.AddTail(_T("DIM ..(..)"));
	basic.AddTail(_T("DATA .., .."));
	basic.AddTail(_T("ELSE"));
	basic.AddTail(_T("EOL$"));
	basic.AddTail(_T("EXP(..)"));
	basic.AddTail(_T("FOR .. TO .. STEP .."));
	basic.AddTail(_T("NEXT .."));
	basic.AddTail(_T("FLOOR(..)"));
	basic.AddTail(_T("GOTO .."));
	basic.AddTail(_T("GOSUB .."));
	basic.AddTail(_T("RETURN"));
	basic.AddTail(_T("IF .. THEN .. ELSE .."));
	basic.AddTail(_T("INSTR(\"..\", \"..\")"));
	basic.AddTail(_T("LEN(\"..\")"));
	basic.AddTail(_T("LOG(..)"));
	basic.AddTail(_T("LOG10(..)"));
	basic.AddTail(_T("LTRIM(\"..\")"));
	basic.AddTail(_T("MID$(\"..\", n, m)"));
	basic.AddTail(_T(".. MOD .."));
	basic.AddTail(_T("ON .. GOTO .., .."));
	basic.AddTail(_T("ON .. GOSUB .."));
	basic.AddTail(_T("PAD(\"..\", n)"));
	basic.AddTail(_T("READ"));
	basic.AddTail(_T("REM"));
	basic.AddTail(_T("RESTORE .."));
	basic.AddTail(_T("RTRIM(\"..\")"));
	basic.AddTail(_T("SGN(..)"));
	basic.AddTail(_T("SIN(..)"));
	basic.AddTail(_T("SQR(..)"));
	basic.AddTail(_T("SQRT(4)"));
	basic.AddTail(_T("STR$(..)"));
	basic.AddTail(_T("TAN(..)"));
	basic.AddTail(_T("TRIM(\"..\")"));
	basic.AddTail(_T("VAL(\"..\")"));
	basic.AddTail(_T("WHILE .."));
	basic.AddTail(_T("WEND"));
