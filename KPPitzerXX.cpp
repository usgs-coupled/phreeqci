...
BEGIN_MESSAGE_MAP(CKPPitzerXX, baseCKPPitzerXX)
	...
	ON_EN_SETFOCUS(IDC_EDIT_A0, &CKPPitzerXX::OnEnSetfocusEditA1)
	ON_EN_SETFOCUS(IDC_EDIT_A0, &CKPPitzerXX::OnEnSetfocusEditA2)
	ON_EN_SETFOCUS(IDC_EDIT_A0, &CKPPitzerXX::OnEnSetfocusEditA3)
	ON_EN_SETFOCUS(IDC_EDIT_A0, &CKPPitzerXX::OnEnSetfocusEditA4)
	ON_EN_SETFOCUS(IDC_EDIT_A0, &CKPPitzerXX::OnEnSetfocusEditA5)
	ON_EN_KILLFOCUS(IDC_EDIT_A0, &CKPPitzerXX::OnEnKillfocusEditA0)
	ON_EN_KILLFOCUS(IDC_EDIT_A0, &CKPPitzerXX::OnEnKillfocusEditA1)
	ON_EN_KILLFOCUS(IDC_EDIT_A0, &CKPPitzerXX::OnEnKillfocusEditA2)
	ON_EN_KILLFOCUS(IDC_EDIT_A0, &CKPPitzerXX::OnEnKillfocusEditA3)
	ON_EN_KILLFOCUS(IDC_EDIT_A0, &CKPPitzerXX::OnEnKillfocusEditA4)
	ON_EN_KILLFOCUS(IDC_EDIT_A0, &CKPPitzerXX::OnEnKillfocusEditA5)
