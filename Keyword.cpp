...
CKeyword::CKeywordMap::CKeywordMap()
{
	...
	(*this).insert(std::map<CString, CKeyword::type>::value_type(_T("solution_mix"),                  CKeyword::K_SOLUTION_MIX));
	(*this).insert(std::map<CString, CKeyword::type>::value_type(_T("mix_solution"),                  CKeyword::K_SOLUTION_MIX));
	(*this).insert(std::map<CString, CKeyword::type>::value_type(_T("exchange_mix"),                  CKeyword::K_EXCHANGE_MIX));
	(*this).insert(std::map<CString, CKeyword::type>::value_type(_T("mix_exchange"),                  CKeyword::K_EXCHANGE_MIX));
	(*this).insert(std::map<CString, CKeyword::type>::value_type(_T("gas_phase_mix"),                 CKeyword::K_GAS_PHASE_MIX));
	(*this).insert(std::map<CString, CKeyword::type>::value_type(_T("mix_gas_phase"),                 CKeyword::K_GAS_PHASE_MIX));
	(*this).insert(std::map<CString, CKeyword::type>::value_type(_T("kinetics_mix"),                  CKeyword::K_KINETICS_MIX));
	(*this).insert(std::map<CString, CKeyword::type>::value_type(_T("mix_kinetics"),                  CKeyword::K_KINETICS_MIX));
	(*this).insert(std::map<CString, CKeyword::type>::value_type(_T("equilibrium_phases_mix"),        CKeyword::K_PPASSEMBLAGE_MIX));
	(*this).insert(std::map<CString, CKeyword::type>::value_type(_T("mix_equilibrium_phases"),        CKeyword::K_PPASSEMBLAGE_MIX));
	(*this).insert(std::map<CString, CKeyword::type>::value_type(_T("equilibrium_phase_mix"),         CKeyword::K_PPASSEMBLAGE_MIX));
	(*this).insert(std::map<CString, CKeyword::type>::value_type(_T("mix_equilibrium_phase"),         CKeyword::K_PPASSEMBLAGE_MIX));
	(*this).insert(std::map<CString, CKeyword::type>::value_type(_T("solid_solutions_mix"),           CKeyword::K_SSASSEMBLAGE_MIX));
	(*this).insert(std::map<CString, CKeyword::type>::value_type(_T("mix_solid_solutions"),           CKeyword::K_SSASSEMBLAGE_MIX));
	(*this).insert(std::map<CString, CKeyword::type>::value_type(_T("solid_solution_mix"),            CKeyword::K_SSASSEMBLAGE_MIX));
	(*this).insert(std::map<CString, CKeyword::type>::value_type(_T("mix_solid_solution"),            CKeyword::K_SSASSEMBLAGE_MIX));
...
{
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_ADVECTION,                     _T("/html/phreeqc3-6.htm#50593793_87438")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_CALCULATE_VALUES,              _T("/html/phreeqc3-7.htm#50593793_35035")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_COPY,                          _T("/html/phreeqc3-8.htm#50593793_76644")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_DATABASE,                      _T("/html/phreeqc3-9.htm#50593793_88316")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_DELETE,                        _T("/html/phreeqc3-10.htm#50593793_33574")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_DUMP,                          _T("/html/phreeqc3-11.htm#50593793_49635")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_END,                           _T("/html/phreeqc3-12.htm#50593793_63178")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_EQUILIBRIUM_PHASES,            _T("/html/phreeqc3-13.htm#50593793_61207")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_EXCHANGE,                      _T("/html/phreeqc3-14.htm#50593793_84573")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_EXCHANGE_MASTER_SPECIES,       _T("/html/phreeqc3-15.htm#50593793_33835")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_EXCHANGE_SPECIES,              _T("/html/phreeqc3-16.htm#50593793_65476")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_GAS_PHASE,                     _T("/html/phreeqc3-17.htm#50593793_83409")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_INCLUDE,                       _T("/html/phreeqc3-18.htm#50593793_74991")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_INCREMENTAL_REACTIONS,         _T("/html/phreeqc3-19.htm#50593793_79204")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_INVERSE_MODELING,              _T("/html/phreeqc3-20.htm#50593793_11066")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_ISOTOPES,                      _T("/html/phreeqc3-21.htm#50593793_32306")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_ISOTOPE_ALPHAS,                _T("/html/phreeqc3-22.htm#50593793_17508")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_ISOTOPE_RATIOS,                _T("/html/phreeqc3-23.htm#50593793_17097")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_KINETICS,                      _T("/html/phreeqc3-24.htm#50593793_55637")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_KNOBS,                         _T("/html/phreeqc3-25.htm#50593793_79000")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_LLNL_AQUEOUS_MODEL_PARAMETERS, _T("/html/phreeqc3-26.htm#50593793_10503")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_MIX,                           _T("/html/phreeqc3-27.htm#50593793_23725")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_PPASSEMBLAGE_MIX,              _T("/html/phreeqc3-28.htm#50593793_79962")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_EXCHANGE_MIX,                  _T("/html/phreeqc3-29.htm#50593793_23595")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_GAS_PHASE_MIX,                 _T("/html/phreeqc3-30.htm#50593793_34676")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_KINETICS_MIX,                  _T("/html/phreeqc3-31.htm#50593793_86166")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_SSASSEMBLAGE_MIX,              _T("/html/phreeqc3-32.htm#50593793_26115")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_SOLUTION_MIX,                  _T("/html/phreeqc3-33.htm#50593793_16756")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_SURFACE_MIX,                   _T("/html/phreeqc3-34.htm#50593793_94543")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_NAMED_EXPRESSIONS,             _T("/html/phreeqc3-35.htm#50593793_62944")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_PHASES,                        _T("/html/phreeqc3-36.htm#50593793_84418")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_PITZER,                        _T("/html/phreeqc3-37.htm#50593793_13650")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_PRINT,                         _T("/html/phreeqc3-38.htm#50593793_92102")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_RATES,                         _T("/html/phreeqc3-39.htm#50593793_97907")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_REACTION,                      _T("/html/phreeqc3-40.htm#50593793_75635")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_REACTION_PRESSURE,             _T("/html/phreeqc3-41.htm#50593793_65966")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_REACTION_TEMPERATURE,          _T("/html/phreeqc3-42.htm#50593793_75016")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_RUN_CELLS,                     _T("/html/phreeqc3-43.htm#50593793_78104")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_SAVE,                          _T("/html/phreeqc3-44.htm#50593793_81857")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_SELECTED_OUTPUT,               _T("/html/phreeqc3-45.htm#50593793_20239")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_SIT,                           _T("/html/phreeqc3-46.htm#50593793_88782")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_SOLID_SOLUTIONS,               _T("/html/phreeqc3-47.htm#50593793_77444")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_SOLUTION,                      _T("/html/phreeqc3-48.htm#50593793_30253")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_SOLUTION_MASTER_SPECIES,       _T("/html/phreeqc3-49.htm#50593793_19910")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_SOLUTION_SPECIES,              _T("/html/phreeqc3-50.htm#50593793_96148")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_SOLUTION_SPREAD,               _T("/html/phreeqc3-51.htm#50593793_84297")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_SURFACE,                       _T("/html/phreeqc3-52.htm#50593793_56392")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_SURFACE_MASTER_SPECIES,        _T("/html/phreeqc3-53.htm#50593793_58106")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_SURFACE_SPECIES,               _T("/html/phreeqc3-54.htm#50593793_92844")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_TITLE,                         _T("/html/phreeqc3-55.htm#50593793_48632")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_TRANSPORT,                     _T("/html/phreeqc3-56.htm#50593793_87317")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_USE,                           _T("/html/phreeqc3-57.htm#50593793_78143")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_USER_GRAPH,                    _T("/html/phreeqc3-58.htm#50593793_26121")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_USER_PRINT,                    _T("/html/phreeqc3-59.htm#50593793_55085")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_USER_PUNCH,                    _T("/html/phreeqc3-60.htm#50593793_56415")));

	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_EQUILIBRIUM_PHASES_MODIFY,     _T("/html/phreeqc3-87.htm#50593805_84573")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_EQUILIBRIUM_PHASES_RAW,        _T("/html/phreeqc3-88.htm#50593805_52879")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_EXCHANGE_MODIFY,               _T("/html/phreeqc3-89.htm#50593805_49135")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_EXCHANGE_RAW,                  _T("/html/phreeqc3-90.htm#50593805_34249")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_GAS_PHASE_MODIFY,              _T("/html/phreeqc3-91.htm#50593805_44837")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_GAS_PHASE_RAW,                 _T("/html/phreeqc3-92.htm#50593805_70184")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_KINETICS_MODIFY,               _T("/html/phreeqc3-93.htm#50593805_79204")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_KINETICS_RAW,                  _T("/html/phreeqc3-94.htm#50593805_64390")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_REACTION_MODIFY,               _T("/html/phreeqc3-95.htm#50593805_31337")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_REACTION_RAW,                  _T("/html/phreeqc3-96.htm#50593805_50923")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_REACTION_PRESSURE_RAW,         _T("/html/phreeqc3-97.htm#50593805_86080")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_REACTION_TEMPERATURE_RAW,      _T("/html/phreeqc3-98.htm#50593805_78104")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_SOLID_SOLUTIONS_MODIFY,        _T("/html/phreeqc3-99.htm#50593805_81857")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_SOLID_SOLUTIONS_RAW,           _T("/html/phreeqc3-100.htm#50593805_63833")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_SOLUTION_MODIFY,               _T("/html/phreeqc3-101.htm#50593805_89789")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_SOLUTION_RAW,                  _T("/html/phreeqc3-102.htm#50593805_69484")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_SURFACE_MODIFY,                _T("/html/phreeqc3-103.htm#50593805_78804")));
	(*this).insert(std::map<CKeyword::type, LPCTSTR>::value_type(CKeyword::K_SURFACE_RAW,                   _T("/html/phreeqc3-104.htm#50593805_23326")));
}
