...
#ifndef baseCKPPitzerCA
#define baseCKPPitzerCA CKeywordPage
#endif

class CKPPitzerCA : public baseCKPPitzerCA
{
	DECLARE_DYNCREATE(CKPPitzerCA)

public:
	CKPPitzerCA(UINT nIDTemplate = CKPPitzerCA::IDD, UINT nIDCaption = 0);
	virtual ~CKPPitzerCA();

// Dialog Data
	enum { IDD = IDD_KEY_PITZER_CA };
