...
// IMPLEMENT_DYNAMIC(CKPPitzerCA, CPropertyPage)
IMPLEMENT_DYNCREATE(CKPPitzerCA, baseCKPPitzerCA)
...
CKPPitzerCA::CKPPitzerCA(UINT nIDTemplate, UINT nIDCaption) : baseCKPPitzerCA(nIDTemplate, nIDCaption)
{
...
CKPPitzerCA::~CKPPitzerCA()
{
}

void CKPPitzerCA::DoDataExchange(CDataExchange* pDX)
{
	baseCKPPitzerCA::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CKPPitzerCA, baseCKPPitzerCA)
	ON_EN_CHANGE(IDC_EDIT_A0, &CKPPitzerCA::OnEnChangeEditA0)
	ON_EN_CHANGE(IDC_EDIT_A1, &CKPPitzerCA::OnEnChangeEditA1)
	ON_EN_CHANGE(IDC_EDIT_A2, &CKPPitzerCA::OnEnChangeEditA2)
	ON_EN_CHANGE(IDC_EDIT_A3, &CKPPitzerCA::OnEnChangeEditA3)
	ON_EN_CHANGE(IDC_EDIT_A4, &CKPPitzerCA::OnEnChangeEditA4)
	ON_EN_CHANGE(IDC_EDIT_A5, &CKPPitzerCA::OnEnChangeEditA5)
	ON_EN_SETFOCUS(IDC_EDIT_A0, &CKPPitzerCA::OnEnSetfocusEditA0)
	ON_EN_SETFOCUS(IDC_EDIT_A1, &CKPPitzerCA::OnEnSetfocusEditA1)
	ON_EN_SETFOCUS(IDC_EDIT_A2, &CKPPitzerCA::OnEnSetfocusEditA2)
	ON_EN_SETFOCUS(IDC_EDIT_A3, &CKPPitzerCA::OnEnSetfocusEditA3)
	ON_EN_SETFOCUS(IDC_EDIT_A4, &CKPPitzerCA::OnEnSetfocusEditA4)
	ON_EN_SETFOCUS(IDC_EDIT_A5, &CKPPitzerCA::OnEnSetfocusEditA5)
	ON_EN_KILLFOCUS(IDC_EDIT_A0, &CKPPitzerCA::OnEnKillfocusEditA0)
	ON_EN_KILLFOCUS(IDC_EDIT_A1, &CKPPitzerCA::OnEnKillfocusEditA1)
	ON_EN_KILLFOCUS(IDC_EDIT_A2, &CKPPitzerCA::OnEnKillfocusEditA2)
	ON_EN_KILLFOCUS(IDC_EDIT_A3, &CKPPitzerCA::OnEnKillfocusEditA3)
	ON_EN_KILLFOCUS(IDC_EDIT_A4, &CKPPitzerCA::OnEnKillfocusEditA4)
	ON_EN_KILLFOCUS(IDC_EDIT_A5, &CKPPitzerCA::OnEnKillfocusEditA5)
	// custom edit grid notifications
	ON_MESSAGE(EGN_BEGINCELLEDIT, &CKPPitzerCA::OnBeginCellEdit)
	ON_MESSAGE(EGN_ENDCELLEDIT, &CKPPitzerCA::OnEndCellEdit)
	ON_MESSAGE(EGN_SETFOCUS, &CKPPitzerCA::OnSetfocusGrid)
	ON_MESSAGE(EGN_CHANGE, &CKPPitzerCA::OnChange)
	ON_MESSAGE(EGN_ALLOW_INSERT_ROW, &CKPPitzerCA::OnAllowInsertRow)
	ON_MESSAGE(EGN_INSERT_ROW, &CKPPitzerCA::OnInsertRow)
	ON_MESSAGE(EGN_ALLOW_DELETE_ROW, &CKPPitzerCA::OnAllowDeleteRow)
	ON_MESSAGE(EGN_DELETE_ROW, &CKPPitzerCA::OnDeleteRow)
	ON_CBN_EDITCHANGE(IDC_CB_CATION, &CKPPitzerCA::OnCbnEditchangeCbCation)
	ON_CBN_SELCHANGE(IDC_CB_CATION, &CKPPitzerCA::OnCbnSelchangeCbCation)
	ON_CBN_EDITCHANGE(IDC_CB_ANION, &CKPPitzerCA::OnCbnEditchangeCbAnion)
	ON_CBN_SELCHANGE(IDC_CB_ANION, &CKPPitzerCA::OnCbnSelchangeCbAnion)
	ON_CBN_SETFOCUS(IDC_CB_CATION, &CKPPitzerCA::OnCbnSetfocusCbCation)
	ON_CBN_SETFOCUS(IDC_CB_ANION, &CKPPitzerCA::OnCbnSetfocusCbAnion)
	ON_WM_SIZE()
END_MESSAGE_MAP()


// CKPPitzerCA message handlers
void CKPPitzerCA::InitGrid(CDataExchange* pDX, int nIDC)
{
	UNUSED(pDX);
...
BOOL CKPPitzerCA::OnInitDialog()
{
	baseCKPPitzerCA::OnInitDialog();
...
void CKPPitzerCA::OnEnChangeEditA0()
{
...
void CKPPitzerCA::OnEnChangeEditA1()
{
...
void CKPPitzerCA::OnEnChangeEditA2()
{
...
void CKPPitzerCA::OnEnChangeEditA3()
{
...
void CKPPitzerCA::OnEnChangeEditA4()
{
...
void CKPPitzerCA::OnEnChangeEditA5()
{
...
void CKPPitzerCA::OnEnSetfocusEditA0()
{
	CString strRes;
...
void CKPPitzerCA::OnEnSetfocusEditA1()
{
	CString strRes;
...
void CKPPitzerCA::OnEnSetfocusEditA2()
{
	CString strRes;
...
void CKPPitzerCA::OnEnSetfocusEditA3()
{
	CString strRes;
...
void CKPPitzerCA::OnEnSetfocusEditA4()
{
	CString strRes;
...
void CKPPitzerCA::OnEnSetfocusEditA5()
{
	CString strRes;
...
void CKPPitzerCA::OnEnKillfocusEditA0()
{
	this->m_hWndLastControl = this->m_ctrlA0.m_hWnd;
	this->m_bEditLastControl = TRUE;	
}

void CKPPitzerCA::OnEnKillfocusEditA1()
{
	this->m_hWndLastControl = this->m_ctrlA1.m_hWnd;
	this->m_bEditLastControl = TRUE;	
}

void CKPPitzerCA::OnEnKillfocusEditA2()
{
	this->m_hWndLastControl = this->m_ctrlA2.m_hWnd;
	this->m_bEditLastControl = TRUE;	
}

void CKPPitzerCA::OnEnKillfocusEditA3()
{
	this->m_hWndLastControl = this->m_ctrlA3.m_hWnd;
	this->m_bEditLastControl = TRUE;	
}

void CKPPitzerCA::OnEnKillfocusEditA4()
{
	this->m_hWndLastControl = this->m_ctrlA4.m_hWnd;
	this->m_bEditLastControl = TRUE;	
}

void CKPPitzerCA::OnEnKillfocusEditA5()
{
	this->m_hWndLastControl = this->m_ctrlA5.m_hWnd;
	this->m_bEditLastControl = TRUE;	
}

BEGIN_EVENTSINK_MAP(CKPPitzerCA, CKeywordPage)
	ON_EVENT(CKPPitzerCA, IDC_MSHFLEXGRID1, 70, CKPPitzerCA::OnRowColChangeGrid, VTS_NONE)
	ON_EVENT(CKPPitzerCA, IDC_MSHFLEXGRID1, 71, CKPPitzerCA::OnEnterCellGrid, VTS_NONE)
	ON_EVENT(CKPPitzerCA, IDC_MSHFLEXGRID1, 72, CKPPitzerCA::OnLeaveCellGrid, VTS_NONE)
	ON_EVENT(CKPPitzerCA, IDC_MSHFLEXGRID1, DISPID_DBLCLICK, CKPPitzerCA::OnDblClickGrid, VTS_NONE)
	ON_EVENT(CKPPitzerCA, IDC_MSHFLEXGRID1, DISPID_KEYDOWN, CKPPitzerCA::OnKeyDownGrid, VTS_PI2 VTS_I2)
	ON_EVENT(CKPPitzerCA, IDC_SRCDBPGCTRL1, 1, CKPPitzerCA::OnGotoFirstClicked, VTS_NONE)
	ON_EVENT(CKPPitzerCA, IDC_SRCDBPGCTRL1, 4, CKPPitzerCA::OnGotoLastClicked, VTS_NONE)
	ON_EVENT(CKPPitzerCA, IDC_SRCDBPGCTRL1, 5, CKPPitzerCA::OnGotoNewClicked, VTS_NONE)
	ON_EVENT(CKPPitzerCA, IDC_SRCDBPGCTRL1, 3, CKPPitzerCA::OnGotoNextClicked, VTS_NONE)
	ON_EVENT(CKPPitzerCA, IDC_SRCDBPGCTRL1, 2, CKPPitzerCA::OnGotoPrevClicked, VTS_NONE)
END_EVENTSINK_MAP()

void CKPPitzerCA::OnRowColChangeGrid()
{
...
void CKPPitzerCA::OnEnterCellGrid()
{
	UINT nResID = 0;
...
void CKPPitzerCA::OnLeaveCellGrid()
{
...
void CKPPitzerCA::OnDblClickGrid()
{
...
void CKPPitzerCA::OnKeyDownGrid(short* KeyCode, short Shift)
{
...
void CKPPitzerCA::OnGotoFirstClicked()
{
...
void CKPPitzerCA::OnGotoLastClicked()
{
...
void CKPPitzerCA::OnGotoNewClicked()
{
...
void CKPPitzerCA::OnGotoNextClicked()
{
...
void CKPPitzerCA::OnGotoPrevClicked()
{
...
LRESULT CKPPitzerCA::OnBeginCellEdit(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CKPPitzerCA::OnEndCellEdit(WPARAM wParam, LPARAM lParam)
{
	TRACE("OnEndCellEdit\n");
...
LRESULT CKPPitzerCA::OnSetfocusGrid(WPARAM wParam, LPARAM lParam)
{
	UINT nID = wParam;
...
LRESULT CKPPitzerCA::OnChange(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CKPPitzerCA::OnAllowDeleteRow(WPARAM wParam, LPARAM lParam)
{
	NMEGINFO* pInfo = (NMEGINFO*)lParam;
	UINT nID = wParam;
...
LRESULT CKPPitzerCA::OnDeleteRow(WPARAM wParam, LPARAM lParam)
{
	NMEGINFO* pInfo = (NMEGINFO*)lParam;
	UINT nID = wParam;
	ASSERT(nID == IDC_MSHFLEXGRID1);
...
LRESULT CKPPitzerCA::OnAllowInsertRow(WPARAM wParam, LPARAM lParam)
{
	NMEGINFO* pInfo = (NMEGINFO*)lParam;
	UINT nID = wParam;
	ASSERT(nID == IDC_MSHFLEXGRID1);
...
LRESULT CKPPitzerCA::OnInsertRow(WPARAM wParam, LPARAM lParam)
{
	NMEGINFO* pInfo = (NMEGINFO*)lParam;
	UINT nID = wParam;
	ASSERT(nID == IDC_MSHFLEXGRID1);
...
void CKPPitzerCA::OnCbnEditchangeCbCation()
{
...
void CKPPitzerCA::OnCbnSelchangeCbCation()
{
...
void CKPPitzerCA::OnCbnEditchangeCbAnion()
{
	TRACE("OnCbnEditchangeCbCation\n");
	if (!this->m_bIgnoreChanges)
	{
...
void CKPPitzerCA::OnCbnSelchangeCbAnion()
{
	TRACE("OnCbnSelchangeCbCation\n");
	if (!this->m_bIgnoreChanges)
	{
...
void CKPPitzerCA::OnCbnSetfocusCbCation()
{
	CString strRes;
...
void CKPPitzerCA::OnCbnSetfocusCbAnion()
{
	CString strRes;
...
void CKPPitzerCA::OnSize(UINT nType, int cx, int cy)
{
