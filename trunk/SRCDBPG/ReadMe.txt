========================================================================
		ActiveX Control DLL : SRCDBPG
========================================================================

ControlWizard has created this project for your SRCDBPG ActiveX Control
...
that make up your SRCDBPG ActiveX Control DLL.
...
SRCDBPGCtl.h
	This file contains the declaration of the CSRCDBPagerCtrl C++ class.

SRCDBPGCtl.cpp
	This file contains the implementation of the CSRCDBPagerCtrl C++ class.

SRCDBPGPpg.h
	This file contains the declaration of the CSRCDBPagerPropPage C++ class.

SRCDBPGPpg.cpp
	This file contains the implementation of the CSRCDBPagerPropPage C++ class.

SRCDBPGCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CSRCDBPagerCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file SRCDBPG.rc.
