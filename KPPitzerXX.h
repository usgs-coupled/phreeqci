...
#ifndef baseCKPPitzerXX
#define baseCKPPitzerXX CKeywordPage
#endif

class CKPPitzerXX : public baseCKPPitzerXX
{
	DECLARE_DYNCREATE(CKPPitzerXX)

public:
	CKPPitzerXX(UINT nIDTemplate = CKPPitzerXX::IDD, UINT nIDCaption = 0);
	virtual ~CKPPitzerXX();

// Dialog Data
	enum { IDD = IDD_KEY_PITZER_XX };
