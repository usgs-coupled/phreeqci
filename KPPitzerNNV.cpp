...
BEGIN_MESSAGE_MAP(CKPPitzerNNV, baseCKPPitzerNNV)
	...
	ON_EN_SETFOCUS(IDC_EDIT_A0, &CKPPitzerNNV::OnEnSetfocusEditA1)
	ON_EN_SETFOCUS(IDC_EDIT_A0, &CKPPitzerNNV::OnEnSetfocusEditA2)
	ON_EN_SETFOCUS(IDC_EDIT_A0, &CKPPitzerNNV::OnEnSetfocusEditA3)
	ON_EN_SETFOCUS(IDC_EDIT_A0, &CKPPitzerNNV::OnEnSetfocusEditA4)
	ON_EN_SETFOCUS(IDC_EDIT_A0, &CKPPitzerNNV::OnEnSetfocusEditA5)
	ON_EN_KILLFOCUS(IDC_EDIT_A0, &CKPPitzerNNV::OnEnKillfocusEditA0)
	ON_EN_KILLFOCUS(IDC_EDIT_A0, &CKPPitzerNNV::OnEnKillfocusEditA1)
	ON_EN_KILLFOCUS(IDC_EDIT_A0, &CKPPitzerNNV::OnEnKillfocusEditA2)
	ON_EN_KILLFOCUS(IDC_EDIT_A0, &CKPPitzerNNV::OnEnKillfocusEditA3)
	ON_EN_KILLFOCUS(IDC_EDIT_A0, &CKPPitzerNNV::OnEnKillfocusEditA4)
	ON_EN_KILLFOCUS(IDC_EDIT_A0, &CKPPitzerNNV::OnEnKillfocusEditA5)
