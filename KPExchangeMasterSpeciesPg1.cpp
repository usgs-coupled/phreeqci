// KPExchangeMasterSpeciesPg1.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CKPExchangeMasterSpeciesPg1, baseCKPExchangeMasterSpeciesPg1)

#undef IDC_EDIT_ELEMENT_NAME
#undef IDC_EDIT_MASTER_SPECIES

/////////////////////////////////////////////////////////////////////////////
// CKPExchangeMasterSpeciesPg1 property page

const long NCOL_IMAGE           = 0;
const long NCOL_EXCHANGE_NAME   = 1;
const long NCOL_EMASTER_SPECIES = 2;

CKPExchangeMasterSpeciesPg1::CKPExchangeMasterSpeciesPg1() : baseCKPExchangeMasterSpeciesPg1(CKPExchangeMasterSpeciesPg1::IDD)
{
	//{{AFX_DATA_INIT(CKPExchangeMasterSpeciesPg1)
...
CKPExchangeMasterSpeciesPg1::~CKPExchangeMasterSpeciesPg1()
{
}

void CKPExchangeMasterSpeciesPg1::DoDataExchange(CDataExchange* pDX)
{
	baseCKPExchangeMasterSpeciesPg1::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CKPExchangeMasterSpeciesPg1)
	DDX_Control(pDX, IDC_EDIT_EXCHANGE_MASTER_SPECIES, m_ctrlEMasterSpecies);
	DDX_Control(pDX, IDC_EDIT_EXCHANGE_NAME, m_ctrlExchangeName);
	...
	if (pDX->m_bSaveAndValidate)
	{
		...
		for (long nRow = 1; nRow < m_ctrlGrid.GetRows(); ++nRow)
		{
			...
			// exchange name
			nCurrentTextBox = IDC_EDIT_EXCHANGE_NAME;
			DDX_GridText(pDX, IDC_MSHFLEXGRID, nRow, NCOL_EXCHANGE_NAME, mast.m_strName);
			...
			// master species
			nCurrentTextBox = IDC_EDIT_EXCHANGE_MASTER_SPECIES;
			DDX_GridText(pDX, IDC_MSHFLEXGRID, nRow, NCOL_EMASTER_SPECIES, mast.m_strMasterSpecies);
...
BEGIN_MESSAGE_MAP(CKPExchangeMasterSpeciesPg1, baseCKPExchangeMasterSpeciesPg1)
	//{{AFX_MSG_MAP(CKPExchangeMasterSpeciesPg1)
	ON_EN_CHANGE(IDC_EDIT_EXCHANGE_NAME, OnChangeEditExchangeName)
	ON_EN_KILLFOCUS(IDC_EDIT_EXCHANGE_NAME, OnKillfocusEditExchangeName)
	ON_EN_SETFOCUS(IDC_EDIT_EXCHANGE_NAME, OnSetfocusEditExchangeName)
	ON_EN_CHANGE(IDC_EDIT_EXCHANGE_MASTER_SPECIES, OnChangeEditExchangeMasterSpecies)
	ON_EN_KILLFOCUS(IDC_EDIT_EXCHANGE_MASTER_SPECIES, OnKillfocusEditExchangeMasterSpecies)
	ON_EN_SETFOCUS(IDC_EDIT_EXCHANGE_MASTER_SPECIES, OnSetfocusEditExchangeMasterSpecies)
	ON_WM_HELPINFO()
	//}}AFX_MSG_MAP
...
BEGIN_EVENTSINK_MAP(CKPExchangeMasterSpeciesPg1, baseCKPExchangeMasterSpeciesPg1)
    //{{AFX_EVENTSINK_MAP(CKPExchangeMasterSpeciesPg1)
	ON_EVENT(CKPExchangeMasterSpeciesPg1, IDC_SRCDBPGCTRL, 1 /* GotoFirstClicked */, OnGotoFirstClicked, VTS_NONE)
	ON_EVENT(CKPExchangeMasterSpeciesPg1, IDC_SRCDBPGCTRL, 4 /* GotoLastClicked */, OnGotoLastClicked, VTS_NONE)
	ON_EVENT(CKPExchangeMasterSpeciesPg1, IDC_SRCDBPGCTRL, 3 /* GotoNextClicked */, OnGotoNextClicked, VTS_NONE)
	ON_EVENT(CKPExchangeMasterSpeciesPg1, IDC_SRCDBPGCTRL, 5 /* GotoNewClicked */, OnGotoNewClicked, VTS_NONE)
	ON_EVENT(CKPExchangeMasterSpeciesPg1, IDC_SRCDBPGCTRL, 2 /* GotoPrevClicked */, OnGotoPrevClicked, VTS_NONE)
	ON_EVENT(CKPExchangeMasterSpeciesPg1, IDC_MSHFLEXGRID, 70 /* RowColChange */, OnRowColChangeGrid, VTS_NONE)
	ON_EVENT(CKPExchangeMasterSpeciesPg1, IDC_MSHFLEXGRID, 72 /* LeaveCell */, OnLeaveCellGrid, VTS_NONE)
	ON_EVENT(CKPExchangeMasterSpeciesPg1, IDC_MSHFLEXGRID, -601 /* DblClick */, OnDblClickGrid, VTS_NONE)
	ON_EVENT(CKPExchangeMasterSpeciesPg1, IDC_MSHFLEXGRID, 71 /* EnterCell */, OnEnterCellGrid, VTS_NONE)
	ON_EVENT(CKPExchangeMasterSpeciesPg1, IDC_MSHFLEXGRID, -602 /* KeyDown */, OnKeyDownGrid, VTS_PI2 VTS_I2)
	//}}AFX_EVENTSINK_MAP
END_EVENTSINK_MAP()


void CKPExchangeMasterSpeciesPg1::InitGrid(CDataExchange* pDX, int nIDC)
{
	UNUSED(pDX);
	...
	m_ctrlGrid.SetColWidth(NCOL_EXCHANGE_NAME,   0, 1500);
	m_ctrlGrid.SetColWidth(NCOL_EMASTER_SPECIES, 0, 2000);

	// set grid titles
    m_ctrlGrid.SetTextMatrix( 0, NCOL_EXCHANGE_NAME,   _T("Exchange name"));
    m_ctrlGrid.SetTextMatrix( 0, NCOL_EMASTER_SPECIES, _T("Exchange master species"));

	// set alignment
	m_ctrlGrid.SetColAlignment(NCOL_EXCHANGE_NAME, flexAlignLeftCenter);
	m_ctrlGrid.SetColAlignment(NCOL_EMASTER_SPECIES, flexAlignLeftCenter);
...
LRESULT CKPExchangeMasterSpeciesPg1::OnBeginCellEdit(WPARAM wParam, LPARAM lParam)
{
	...
	case IDC_MSHFLEXGRID :
		...
		{
		case NCOL_EXCHANGE_NAME:
			break;
		case NCOL_EMASTER_SPECIES:
			break;
		default :
			ASSERT(FALSE);
			break;
...
LRESULT CKPExchangeMasterSpeciesPg1::OnChange(WPARAM wParam, LPARAM lParam)
{
	TRACE("OnChange\n");
	...
	case IDC_MSHFLEXGRID :
		...
		{
		case NCOL_EXCHANGE_NAME:
			m_ctrlExchangeName.SetWindowText(pInfo->item.pszText);
			break;
		case NCOL_EMASTER_SPECIES:
			m_ctrlEMasterSpecies.SetWindowText(pInfo->item.pszText);
			break;
		default :
			ASSERT(FALSE);
			break;
...
void CKPExchangeMasterSpeciesPg1::OnChangeEditExchangeMasterSpecies() 
{
	TRACE("OnChangeEditExchangeMasterSpecies\n");

	if (!m_bIgnoreChanges)
	{
		CString str;
		m_ctrlEMasterSpecies.GetWindowText(str);
		m_ctrlGrid.SetTextMatrix(m_ctrlGrid.GetRow(), NCOL_EMASTER_SPECIES, str);
	}
}

void CKPExchangeMasterSpeciesPg1::OnChangeEditExchangeName() 
{
	TRACE("OnChangeEditExchangeName\n");

	if (!m_bIgnoreChanges)
	{
		CString str;
		m_ctrlExchangeName.GetWindowText(str);
		m_ctrlGrid.SetTextMatrix(m_ctrlGrid.GetRow(), NCOL_EXCHANGE_NAME, str);
		if (str.GetLength() > 0)
		{
...
void CKPExchangeMasterSpeciesPg1::OnDblClickGrid() 
{
...
LRESULT CKPExchangeMasterSpeciesPg1::OnEndCellEdit(WPARAM wParam, LPARAM lParam)
{
	TRACE("OnEndCellEdit\n");
	...
	case IDC_MSHFLEXGRID :
		...
		case NCOL_EXCHANGE_NAME:
			...
			{
				// edit cancelled
				m_ctrlExchangeName.SetWindowText(m_ctrlGrid.GetTextMatrix(pInfo->item.iRow, pInfo->item.iCol));
			}
			else
			{
				m_ctrlExchangeName.SetWindowText(pInfo->item.pszText);
		...
		case NCOL_EMASTER_SPECIES:
			...
			{
				// edit cancelled
				m_ctrlEMasterSpecies.SetWindowText(m_ctrlGrid.GetTextMatrix(pInfo->item.iRow, pInfo->item.iCol));
			}
			else
			{
				m_ctrlEMasterSpecies.SetWindowText(pInfo->item.pszText);
...
void CKPExchangeMasterSpeciesPg1::OnEnterCellGrid() 
{
	UINT nResID = 0;
	switch (m_ctrlGrid.GetCol())
	{
	case NCOL_EXCHANGE_NAME:
		nResID = IDS_STRING588;
		break;

	case NCOL_EMASTER_SPECIES:
		nResID = IDS_STRING589;
		break;
...
void CKPExchangeMasterSpeciesPg1::OnGotoFirstClicked() 
{
...
void CKPExchangeMasterSpeciesPg1::OnGotoLastClicked() 
{
...
void CKPExchangeMasterSpeciesPg1::OnGotoNewClicked() 
{
	...
	m_ctrlExchangeName.SetFocus();
	m_ctrlExchangeName.SetSel(0, -1);
}

void CKPExchangeMasterSpeciesPg1::OnGotoNextClicked() 
{
...
void CKPExchangeMasterSpeciesPg1::OnGotoPrevClicked() 
{
...
BOOL CKPExchangeMasterSpeciesPg1::OnHelpInfo(HELPINFO* pHelpInfo) 
{
	...
	{
	case IDC_EDIT_EXCHANGE_NAME: case IDC_STATIC_EXCHANGE_NAME:
		strRes.LoadString(IDS_STRING588);
		break;
	case IDC_EDIT_EXCHANGE_MASTER_SPECIES: case IDC_STATIC_EXCHANGE_MASTER_SPECIES:
		strRes.LoadString(IDS_STRING589);
		break;
	case IDC_MSHFLEXGRID:
		if (!IsContextHelp())
		{
		...
		<< (paneCtrl(IDC_STATIC_MAIN, HORIZONTAL, ABSOLUTE_VERT, nDefaultBorder, 10, 10)
			<< (pane(VERTICAL, GREEDY)
				<< (pane(HORIZONTAL, GREEDY)
					<< item(IDC_STATIC_EXCHANGE_NAME, NORESIZE)
					<< itemFixed(HORIZONTAL, 24)
					<< item(IDC_STATIC_EXCHANGE_MASTER_SPECIES, NORESIZE)
					)
				<< (pane(HORIZONTAL, GREEDY)
					<< item(IDC_EDIT_EXCHANGE_NAME, NORESIZE)
					<< itemFixed(HORIZONTAL, 24)
					<< item(IDC_EDIT_EXCHANGE_MASTER_SPECIES, NORESIZE)
					)
				)
			)
...
void CKPExchangeMasterSpeciesPg1::OnKeyDownGrid(short FAR* KeyCode, short Shift) 
{
...
void CKPExchangeMasterSpeciesPg1::OnKillfocusEditExchangeMasterSpecies() 
{
	m_hWndLastControl = m_ctrlEMasterSpecies.m_hWnd;
	m_bEditLastControl = TRUE;	
}

void CKPExchangeMasterSpeciesPg1::OnKillfocusEditExchangeName() 
{
	m_hWndLastControl = m_ctrlExchangeName.m_hWnd;
	m_bEditLastControl = TRUE;	
}

void CKPExchangeMasterSpeciesPg1::OnLeaveCellGrid() 
{
...
void CKPExchangeMasterSpeciesPg1::OnRowColChangeGrid() 
{
	...
	// Exchange name
	m_ctrlExchangeName.SetWindowText(m_ctrlGrid.GetTextMatrix(nRow, NCOL_EXCHANGE_NAME));

	// Exchange master species
	m_ctrlEMasterSpecies.SetWindowText(m_ctrlGrid.GetTextMatrix(nRow, NCOL_EMASTER_SPECIES));
...
void CKPExchangeMasterSpeciesPg1::OnSetfocusEditExchangeMasterSpecies() 
{
	CString strRes;
	strRes.LoadString(IDS_STRING589);
	m_eInputDesc.SetWindowText(strRes);	
...
void CKPExchangeMasterSpeciesPg1::OnSetfocusEditExchangeName() 
{
	CString strRes;
	strRes.LoadString(IDS_STRING588);
	m_eInputDesc.SetWindowText(strRes);	
...
LRESULT CKPExchangeMasterSpeciesPg1::OnSetfocusGrid(WPARAM wParam, LPARAM lParam)
{
	UINT nID = wParam;
...
void CKPExchangeMasterSpeciesPg1::ResetFocus()
{
