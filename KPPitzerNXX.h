...
#ifndef baseCKPPitzerNXX
#define baseCKPPitzerNXX CKeywordPage
#endif

class CKPPitzerNXX : public baseCKPPitzerNXX
{
	DECLARE_DYNCREATE(CKPPitzerNXX)

public:
	CKPPitzerNXX(UINT nIDTemplate = CKPPitzerNXX::IDD, UINT nIDCaption = 0);
	virtual ~CKPPitzerNXX();

// Dialog Data
	enum { IDD = IDD_KEY_PITZER_NXX };
